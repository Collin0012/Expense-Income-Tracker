...
def add_expense(request):
    ...
    if request.method == 'POST' and request.FILES['receipt']:
        ...
        Expense.objects.create(owner=request.user, receipt=receipt, amount=amount, date=date, category=category, description=description)
